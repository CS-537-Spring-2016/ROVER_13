	...
	*//**
	...
	private void run() throws IOException, InterruptedException {
		...
		while (true) {
			...
			//System.out.println("ROVER_13 equipment list results drive " + equipment.get(0));
			...
			if (blocked) {
				for (int i = 0; i < 5; i++) {
					out.println("MOVE E");
					//System.out.println("ROVER_13 request move E");
					Thread.sleep(300);
				}
				blocked = false;
				...
				if (goingSouth) {
					...
					if (scanMapTiles[centerIndex][centerIndex +1].getHasRover() 
						...
						out.println("MOVE S");
						//System.out.println("ROVER_13 request move S");
					}
					...
					if (scanMapTiles[centerIndex][centerIndex -1].getHasRover() //NORTH
						...
						// request to server to move
						out.println("MOVE N");
						//System.out.println("ROVER_13 request move N");
					}					
				}
			}
			...
			//System.out.println("ROVER_13 currentLoc after recheck: " + currentLoc);
	...
	private ArrayList<String> getEquipment() throws IOException {
		...
		//System.out.println("ROVER_13 incomming EQUIPMENT result - first readline: " + jsonEqListIn);
		...
		if(jsonEqListIn.startsWith("EQUIPMENT")){
			while (!(jsonEqListIn = in.readLine()).equals("EQUIPMENT_END")) {
				...
				//System.out.println("ROVER_13 incomming EQUIPMENT result: " + jsonEqListIn);
	...
	public void doScan() throws IOException {
		...
		if(jsonScanMapIn.startsWith("SCAN")){	
			while (!(jsonScanMapIn = in.readLine()).equals("SCAN_END")) {
				//System.out.println("ROVER_13 incomming SCAN result: " + jsonScanMapIn);
		...
		//System.out.println("ROVER_13 convert from json back to ScanMap class");
